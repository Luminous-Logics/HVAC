...
import logoScrolled from "../../../assets/images/logoblue.svg";
    ...
    <header id="header" className={`header d-flex align-items-center fixed-top ${isScrolled ? "scrolled" : ""}`}>
      <div className="container-fluid container-xl position-relative d-flex align-items-center">
        ...
        <a href="/" className="logo d-flex align-items-center me-auto">
          <img className="logo-main" src={isScrolled ? logoScrolled : logo} alt="Sabah Hvac"/>
        </a>
        {/* Navigation Menu */}
        <nav id="navmenu" className="navmenu">
          <div className="dropdown-center">
            ...
            <Icon icon="ri:menu-fill" width="24"  height="24"  color={isScrolled ? "black" : "white"} />             
            </button>
            {/* Dropdown Menu */}
            {isDropdownOpen && (
